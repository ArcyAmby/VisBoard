        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title">George Juaquin Montano</h2>
		...
		Make notes on what you might like to include in your own portfolio then move on to our designer portfolio checklist.
            ...
            <div class="comments">
              ...
              <div class="reply-form">
                ...
                <form action="blog-details-2.php" method="post">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input name="Demail" id="Demail" type="text" class="form-control" placeholder="Designer email" value="<?php echo $fetch1['Demail']?>" required>
                    </div>
						...
						success: function(data){
							Swal.fire({
								...
								icon: "success"
											...
											window.location = "blog-details-2.php";
									});
