        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title">Ashley Martin</h2>
...
Make notes on what you might like to include in your own portfolio then move on to our designer portfolio checklist.
            ...
            <div class="post-author d-flex align-items-center">
              ...
              <div>
                ...
                <div class="social-links">
                  ...
                  <a href="https://instagram.com/#"><i class="bi bi-microsoft"></i></a>
                </div>
                <p>
            ...
            <div class="comments">
              ...
              <div class="reply-form">
                ...
                <form action="blog-details-1.php" method="post">
                  <div class="row">
						...
						success: function(data){
							Swal.fire({
								...
								icon: "success"
											...
											window.location = "blog-details-1.php";
									});
